const Navbar = () => {
    return (
          <div className="w-full relative shadow-[0px_8px_22px_-6px_rgba(24,_39,_75,_0.12),_0px_14px_64px_-4px_rgba(24,_39,_75,_0.12)] rounded-[40px] bg-white flex flex-col items-start justify-start py-4 px-6 box-border text-left text-base text-slateblue font-open-sans">
